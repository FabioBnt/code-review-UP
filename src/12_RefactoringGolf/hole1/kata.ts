...
export class Game {
  ...
  private isRowFull(row: number) {
    return this._board.TileAt(row, this.firstColumn).Symbol != this.emptyPlay &&
  ...
  private isRowFullWithSameSymbol(row: number) {
    return this._board.TileAt(row, this.firstColumn)!.Symbol == this._board.TileAt(row, this.secondColumn)!.Symbol &&
      this._board.TileAt(row, this.secondColumn)!.Symbol == this._board.TileAt(row, this.thirdColumn)!.Symbol;
  }
}
